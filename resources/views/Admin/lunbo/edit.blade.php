...
<form enctype="multipart/form-data" class="am-form tpl-form-line-form" id="formData">
    ...
    <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
            <input value="{{ $arr['name'] }}" id="name" type="text" placeholder="输入SEO关键字">
        </div>
    </div>
    ...
    <div class="am-form-group">
        ...
        <div class="am-u-sm-9 image">
            <input id="pic" class="pic" type="file" multiple>
        </div>
    </div>
</form>
<div class="am-form-group">
    <div class="am-u-sm-9 am-u-sm-push-3">
        <button id="btn" type="button" class="am-btn am-btn-primary tpl-btn-bg-color-success ">修改</button>
