            ...
            <div class="widget-body am-fr">
                ...
                <form class="am-form tpl-form-border-form tpl-form-border-br">
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name=name class="tpl-form-input" id="user-name" placeholder="请输入权限名">
                            <small></small></div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name='controller' placeholder="输入控制器名"></div>
                    </div>
                    ...
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <input type="text" name='action' id="user-weibo" placeholder="请添加操作方法名">
                            <div></div>
                        </div>
                    </div>                    
                    <div class="am-form-group">
                        ...
                        <div class="am-u-sm-9">
                            <textarea class="" name='descr' rows="3" id="user-intro" placeholder="描述在5-20字左右"></textarea>
                        </div>
                    </div>
                    <div class="am-form-group">
