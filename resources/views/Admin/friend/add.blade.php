...
<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
    <div class="widget am-cf">
        <div class="widget-head am-cf">
            <div class="widget-title am-fl">添加友链</div>
        ...
        <div class="am-btn am-btn-default am-btn-danger" id="errors" style="display:none" role="alert">
            ...
            <form class="am-form tpl-form-line-form">
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <input id="name" type="text" class="tpl-form-input" id="user-name" placeholder="请输入友链名">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-9">
                        <input id="url" type="text" class="am-form-field tpl-form-no-bg" placeholder="友链地址">
                        <small>友链地址</small>
                    </div>
                </div>
