    ...
    <div class="content clearfix bgf5">
        <section class="user-center inner clearfix">
            <div class="pull-left bgf">
                ...
                <dl class="user-center__nav">
                    <dt>订单中心</dt>
                    <a href="\home\userorder"><dd>我的订单</dd></a>
                    <a href="\home\showcomment"><dd>我的评价</dd></a>
                    <a href="\home\collect"><dd>我的收藏</dd></a>
                </dl>
                <dl class="user-center__nav">
                    <dt>服务中心</dt>
    ...
    <div class="footer">
        ...
        <div class="copy-box clearfix">
            ...
            <p class="copyright">
                ...
                ICP备案证书号：闽ICP备16015525号-2&nbsp;&nbsp;&nbsp;&nbsp;福建省宁德市福鼎市南下村小区（锦昌阁）1栋1梯602室&nbsp;&nbsp;&nbsp;&nbsp;Tel: 18650406668&nbsp;&nbsp;&nbsp;&nbsp;E-mail: 18276125507@qq.com
            </p>
        </div>
    </div>
@yield('js')
