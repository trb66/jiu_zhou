...
     $(this).children().css('border', '1px solid #b31e22').css('color','#b31e22');
   	...
   	if(s.length == x) {
       	...
       	$('.tihuan').html('<div class=" tihuan"><a href="javascript:;"rel="nofollow"onclick="return gobuy(this)" data-addfastbuy="true" title="点击此按钮，到下一步确认购买信息。" role="button" class="item-action__buy">立即购买</a><a  href="javascript:;" onclick="return addcar(this)"rel="nofollow"data-addfastbuy="true" role="button" class="item-action__basket">	<i class="iconfont icon-shopcart"></i>加入购物车</a></div>')
